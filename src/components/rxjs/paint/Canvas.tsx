...
function basicPaint(canvas: CanvasRenderingContext2D, coords: Coords) {
    paint(canvas, { ...coords, color: "black", thickness: 1 })
}

function colorPaint(canvas: CanvasRenderingContext2D, coords: Coords, color: string) {
    paint(canvas, { ...coords, color, thickness: 1 })
}
