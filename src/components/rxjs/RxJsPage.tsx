...
const Navigation = ({basePath}: NaviationProps) => (
    <nav>
        <ul>
            ...
            <NavItem text="Paint" path={`${basePath}/paint`}/>
        </ul>
    </nav>
)
...
const PaintPage = React.lazy(() => import(/* webpackChunkName: "PaintPage" */"./paint/PaintPage"))
        ...
        <div className="rxjs-page">
            ...
            <Switch>
                <Suspense fallback={<div>Loading page...</div>}>
                    ...
                    <Route path={`${url}/paint`} exact component={PaintPage}/>
                </Suspense>
            </Switch>
        </div>
    )
